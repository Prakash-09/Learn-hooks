...
export default function MultipleUseReducers() {
    ...
    return(
        <div>
            ...
            <div className="text-center">Count Two - {countTwo}</div>
            <div className="text-center">
            <Button variant="primary" size="sm" className="m-2" onClick={() => dispatchTwo('increment')}>Increment</Button>
            <Button variant="primary" size="sm" className="m-2" onClick={() => dispatchTwo('decrement')}>Decrement</Button>
            <Button variant="primary" size="sm" className="m-2" onClick={() => dispatchTwo('reset')}>Reset</Button>
            </div>
        </div>
    );
}